# 单细胞进阶方法_scRNA-Advanced 骨架 status=skeleton
...
run_merged_skeleton <- function(input_path = NULL, out_dir = tempfile("bioinfo_"),
  ...
  message("【骨架】单细胞进阶方法_scRNA-Advanced input=", input_path, " out=", out_dir)
  invisible(list(status = "skeleton", folder = "单细胞进阶方法_scRNA-Advanced", pkgs_checked = present))
}
