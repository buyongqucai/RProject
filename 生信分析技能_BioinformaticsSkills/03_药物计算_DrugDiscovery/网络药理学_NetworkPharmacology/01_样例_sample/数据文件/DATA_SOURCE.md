...
- **出图**: PPI 与 HCTP **代码绘制（交付默认）**，无需 Cytoscape 手绘；可达性总表见 `../文档_docs/数据库可达性与自动获取_DBAutomation.md`
- **AUTO（本机已测）**: CTD bulk、KEGG REST、STRING API
- **MANUAL（需你导出）**: GeneCards、TTD、DrugBank、OMIM、DisGeNET、TCMSP、BATMAN、ETCM2、HERB、TCMBank、SwissTargetPrediction
