# 样例分析脚本 — 分子对接与虚拟筛选_MolecularDocking
# 合规：统一交付规范_DeliveryStandards + 统一可视化规范_VizStandards
# analysis_kind=blocked_docking  seed=59089
...
skill_en <- "MolecularDocking"
skill_folder <- "分子对接与虚拟筛选_MolecularDocking"
...
blocked_reason <- "需 AutoDock Vina/商业对接软件与受体准备流水线"
stub <- data.frame(
