# 类药性与QSAR_ADMET-QSAR 骨架 status=skeleton
...
run_merged_skeleton <- function(input_path = NULL, out_dir = tempfile("bioinfo_"),
  ...
  message("【骨架】类药性与QSAR_ADMET-QSAR input=", input_path, " out=", out_dir)
  invisible(list(status = "skeleton", folder = "类药性与QSAR_ADMET-QSAR", pkgs_checked = present))
}
