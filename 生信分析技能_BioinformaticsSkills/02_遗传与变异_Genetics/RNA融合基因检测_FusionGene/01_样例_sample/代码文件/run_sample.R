# 样例分析脚本 — RNA融合基因检测_FusionGene
# 合规：统一交付规范_DeliveryStandards + 统一可视化规范_VizStandards
# analysis_kind=blocked_fusion  seed=31840
...
skill_en <- "FusionGene"
skill_folder <- "RNA融合基因检测_FusionGene"
...
blocked_reason <- "需 RNA-seq BAM/FASTQ 与 STAR-Fusion/Arriba"
stub <- data.frame(
