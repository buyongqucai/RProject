# 样例分析脚本 — 基因组组装与注释_GenomeAssembly
# 合规：统一交付规范_DeliveryStandards + 统一可视化规范_VizStandards
# analysis_kind=blocked_assembly  seed=38148
...
skill_en <- "GenomeAssembly"
skill_folder <- "基因组组装与注释_GenomeAssembly"
...
blocked_reason <- "需大规模测序读段与组装器（SPAdes/Flye 等）及 TB 级磁盘"
stub <- data.frame(
