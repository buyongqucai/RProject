# 肿瘤体细胞景观_TumorSomatic 骨架 status=skeleton
...
run_merged_skeleton <- function(input_path = NULL, out_dir = tempfile("bioinfo_"),
  ...
  message("【骨架】肿瘤体细胞景观_TumorSomatic input=", input_path, " out=", out_dir)
  invisible(list(status = "skeleton", folder = "肿瘤体细胞景观_TumorSomatic", pkgs_checked = present))
}
