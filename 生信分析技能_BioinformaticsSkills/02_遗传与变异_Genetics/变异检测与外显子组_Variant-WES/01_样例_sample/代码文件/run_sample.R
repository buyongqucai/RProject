# 样例分析脚本 — 变异检测与外显子组_Variant-WES
# 合规：统一交付规范_DeliveryStandards + 统一可视化规范_VizStandards
# analysis_kind=blocked_wes  seed=40219
...
skill_en <- "Variant-WES"
skill_folder <- "变异检测与外显子组_Variant-WES"
...
blocked_reason <- "需 WES BAM/GATK 完整最佳实践流水线"
stub <- data.frame(
