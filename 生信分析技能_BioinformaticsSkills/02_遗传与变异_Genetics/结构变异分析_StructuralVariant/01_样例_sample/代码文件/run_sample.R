# 样例分析脚本 — 结构变异分析_StructuralVariant
# 合规：统一交付规范_DeliveryStandards + 统一可视化规范_VizStandards
# analysis_kind=blocked_sv  seed=45035
...
skill_en <- "StructuralVariant"
skill_folder <- "结构变异分析_StructuralVariant"
...
blocked_reason <- "需全基因组 BAM 与 manta/delly 等 SV caller"
stub <- data.frame(
