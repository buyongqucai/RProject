# 样例分析脚本 — 放射组学与病理组学_Radiomics-Pathomics
# 合规：统一交付规范_DeliveryStandards + 统一可视化规范_VizStandards
# analysis_kind=blocked_radiomics  seed=51746
...
skill_en <- "Radiomics-Pathomics"
skill_folder <- "放射组学与病理组学_Radiomics-Pathomics"
...
blocked_reason <- "需医学影像 DICOM/WSI 与 pyradiomics 环境"
stub <- data.frame(
