# 代谢组分析_Metabolomics 骨架 status=skeleton
...
run_merged_skeleton <- function(input_path = NULL, out_dir = tempfile("bioinfo_"),
  ...
  message("【骨架】代谢组分析_Metabolomics input=", input_path, " out=", out_dir)
  invisible(list(status = "skeleton", folder = "代谢组分析_Metabolomics", pkgs_checked = present))
}
