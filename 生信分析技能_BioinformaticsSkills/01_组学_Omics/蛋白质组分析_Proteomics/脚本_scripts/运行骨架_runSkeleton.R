# 蛋白质组分析_Proteomics 骨架 status=skeleton
...
run_merged_skeleton <- function(input_path = NULL, out_dir = tempfile("bioinfo_"),
  ...
  message("【骨架】蛋白质组分析_Proteomics input=", input_path, " out=", out_dir)
  invisible(list(status = "skeleton", folder = "蛋白质组分析_Proteomics", pkgs_checked = present))
}
