# 样例分析脚本 — 表观遗传ChIP-seq_Epigenomics
# 合规：统一交付规范_DeliveryStandards + 统一可视化规范_VizStandards
# analysis_kind=blocked_chip  seed=59951
...
skill_en <- "Epigenomics"
skill_folder <- "表观遗传ChIP-seq_Epigenomics"
...
blocked_reason <- "需 ChIP FASTQ 与 MACS2/bowtie 比对栈"
stub <- data.frame(
