# 清单：生存分析与预后模型_Survival

**路径:** `04_临床预测与统计_ClinicalStats/生存分析与预后模型_Survival`  
**范式:** `docs/agents/技能范式清单_SkillParadigm.md`  
**状态:** 已审  
**总评:** 合规  
**结构:** lines=72 docs=0 scripts=2 flags=none

## 技能说明

| 文件 | A1-A3 | B1-B4 | 判定 | 笔记 |
|------|-------|-------|------|------|
| `技能说明_生存分析与预后模型_Survival.md` | PASS | PASS | 合规 | lines=72 |
