# 清单：代谢组分析_Metabolomics

**路径:** `01_组学_Omics/代谢组分析_Metabolomics`  
**范式:** `docs/agents/技能范式清单_SkillParadigm.md`  
**状态:** 已审  
**总评:** 合规  
**结构:** lines=63 docs=0 scripts=3 flags=none

## 技能说明

| 文件 | A1-A3 | B1-B4 | 判定 | 笔记 |
|------|-------|-------|------|------|
| `技能说明_代谢组分析_Metabolomics.md` | PASS | PASS | 合规 | lines=63 |
...
| `运行代谢组骨架_runMetabolomicsSkeleton.R` | 有 | 按技能 | 保留 |  |
