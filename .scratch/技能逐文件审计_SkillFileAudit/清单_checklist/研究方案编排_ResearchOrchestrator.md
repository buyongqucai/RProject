# 清单：研究方案编排_ResearchOrchestrator

**路径:** `00_基础_Foundation/研究方案编排_ResearchOrchestrator`  
**范式:** `docs/agents/技能范式清单_SkillParadigm.md`  
**状态:** 已审  
**总评:** 合规  
**结构:** lines=139 docs=0 scripts=1 flags=none

## 技能说明

| 文件 | A1-A3 | B1-B4 | 判定 | 笔记 |
|------|-------|-------|------|------|
| `技能说明_研究方案编排_ResearchOrchestrator.md` | PASS | PASS | 合规 | lines=139 |
